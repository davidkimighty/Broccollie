...
namespace CollieMollie.Helper
{
    ...
    {
        #region Save Load
        public static IEnumerator LoadDataDecrypt(string saveFolderPath, string fileName, string aesKey, object data)
        {
        ...
        public static IEnumerator SaveDataEncrypt(string savePath, string aesKey, object data)
        {
            try
            {
                Aes aes = Aes.Create();
